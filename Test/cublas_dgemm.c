...
{	
	...
	cudaMalloc((void**)&device_a,sizeof(double)*m*k); 
  	cudaMalloc((void**)&device_b,sizeof(double)*k*n);
  	cudaMalloc((void**)&device_c,sizeof(double)*m*n); 

	cudaMemcpy(device_a,host_a,sizeof(double)*m*k,cudaMemcpyHostToDevice); 
  	cudaMemcpy(device_b,host_b,sizeof(double)*k*n,cudaMemcpyHostToDevice); 
	cudaMemcpy(device_c,host_c,sizeof(double)*m*n,cudaMemcpyHostToDevice); 
	...
	cudaMemcpy(host_c,device_c,sizeof(double)*m*n,cudaMemcpyDeviceToHost);
